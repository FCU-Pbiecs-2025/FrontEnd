<template>
  ...
  <footer>
    ...
    <p>手機及平板裝置建議使用CHROME瀏覽器，可支援更多系統功能</p>
  </footer>
</template>
...
/* 最新消息樣式 */
.news {
  margin: 32px auto 0 auto; /* 減少與卡片區距離 */
  max-width: 1200px;
  background: transparent;
  border-radius: 16px;
  box-shadow: none;
  padding: 40px 40px 48px 40px; /* 適度上下內距 */
}

.news-title {
  display: flex;
  align-items: center;
  margin-bottom: 32px; /* 適度標題下方間距 */
}
...
.news-box {
  ...
  border-radius: 12px;
  padding: 32px 32px 32px 32px; /* 內容區塊更大 */
  min-height: 700px; /* 內容區塊更大 */
  max-height: 90vh; /* 幾乎填滿視窗 */
...
.news-date {
  ...
  align-items: center;
  justify-content: center;
  width: 100px; /* 增加日期區塊寬度 */
  min-width: 100px;
  background: #F9AFAE;
  border-radius: 8px;
  padding: 12px; /* 增加日期區塊內部間距 */
  margin-right: 24px; /* 增加右邊距 */
  text-align: center;
}
